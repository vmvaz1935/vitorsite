    ...
    >
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="flex-1">
          <p className="text-gray-700 mb-4">Vitor Vaz é fisioterapeuta graduado pela Universidade Federal de São Paulo (UNIFESP) e doutor em Saúde Baseada em Evidências pela Escola Paulista de Medicina【811834257920451†L88-L107】. Possui formação avançada em terapia manual (conceito Mulligan) e larga experiência na área traumato-ortopédica e esportiva através do Centro Interprofissional de Pesquisa e Estudo do Esporte associado à UNIFESP.</p>
